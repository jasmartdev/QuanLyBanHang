...
public class KhachHangAdapter extends BaseAdapter {
    ...
    public KhachHangAdapter(Context context, KhachHang[] khachHangs) {
    ...
    @Override
    public int getCount() {
        return khachHangs.length;
    }

    @Override
    public Object getItem(int position) {
        return khachHangs[position];
    }

    @Override
    public long getItemId(int position) {
        return khachHangs[position].getId();
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final KhachHang khachHang = khachHangs[position];
